...
function fetchWithAsyncAwait(url) {
    return __awaiter(this, void 0, void 0, function () {
        var data, additionalData, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetchAdditionalData()];
                case 2:
                    additionalData = _a.sent();
                    console.log('Fetched additional data:', additionalData);
                    return [2 /*return*/, __assign(__assign({}, data), additionalData)];
                case 3:
                    error_1 = _a.sent();
